...
function SecondPage({ formData, handleFormDataChange }) {
    ...
    const [isFormComplete, setIsFormComplete] = useState(false); // Track form completion state
    ...
    useEffect(() => {
        // Check if the form is complete (all fields are filled)
    ...
    function validateForm() {
        // Checking if the area, city, pincode, and location are filled
        const isComplete = formData.area && formData.city && formData.pincode && location;
        setIsFormComplete(isComplete); // Update form completion status
        handleFormDataChange({ isFormComplete: isComplete }); // Pass the form completion status to parent component
    }
